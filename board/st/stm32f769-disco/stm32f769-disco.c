...
static const struct stm32_gpio_dsc ext_ram_fmc_gpio[] = {
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_10},	/* D5, FMC_D31 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_9},	/* E4, FMC_D30 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_7},	/* D4, FMC_D29 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_6},	/* D6, FMC_D28 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_3},	/* C13, FMC_D27 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_2},	/* C14, FMC_D26 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_1},	/* D14, FMC_D25 */
	{STM32_GPIO_PORT_I, STM32_GPIO_PIN_0},	/* E14, FMC_D24 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_15},	/* D13, FMC_D23 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_14},	/* E13, FMC_D22 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_13},	/* E12, FMC_D21 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_12},	/* M15, FMC_D20 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_11},	/* N15, FMC_D19 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_10},	/* P15, FMC_D18 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_9},	/* N14, FMC_D17 */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_8},	/* P14, FMC_D16 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_10},	/* K15, FMC_D15 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_9},	/* L14, FMC_D14 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_8},	/* L15, FMC_D13 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_15},	/* R11, FMC_D12 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_14},	/* P11, FMC_D11 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_13},	/* R12, FMC_D10 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_12},	/* R10, FMC_D9 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_11},	/* P10, FMC_D8 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_10},	/* R9, FMC_D7 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_9},	/* P9, FMC_D6 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_8},	/* N9, FMC_D5 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_7},	/* R8, FMC_D4 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_1},	/* 115, FMC_D3 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_0},	/* 114, FMC_D2 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_15},	/* K13, FMC_D1 */
	{STM32_GPIO_PORT_D, STM32_GPIO_PIN_14},	/* L12, FMC_D0 */

	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_1},	/* A5, FMC_NBL1 */
	{STM32_GPIO_PORT_E, STM32_GPIO_PIN_0},	/* A6, FMC_NBL0 */

	{STM32_GPIO_PORT_G, STM32_GPIO_PIN_5},	/* N11, FMC_A15, BA1 */
	{STM32_GPIO_PORT_G, STM32_GPIO_PIN_4},	/* N12, FMC_A14, BA0 */

	{STM32_GPIO_PORT_G, STM32_GPIO_PIN_1},	/* L7, FMC_A11 */
	{STM32_GPIO_PORT_G, STM32_GPIO_PIN_0},	/* N8, FMC_A10 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_15},	/* M8, FMC_A9 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_14},	/* P6, FMC_A8 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_13},	/* N6, FMC_A7 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_12},	/* M6, FMC_A6 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_5},	/* K3, FMC_A5 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_4},	/* J2, FMC_A4 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_3},	/* H2, FMC_A3 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_2},	/* G2, FMC_A2 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_1},	/* E2, FMC_A1 */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_0},	/* D2, FMC_A0 */

	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_3},	/* J4, SDRAM_NE */
	{STM32_GPIO_PORT_F, STM32_GPIO_PIN_11},	/* P8, SDRAM_NRAS */
	{STM32_GPIO_PORT_G, STM32_GPIO_PIN_15},	/* B7, SDRAM_NCAS */
	{STM32_GPIO_PORT_H, STM32_GPIO_PIN_5},	/* J3, SDRAM_NWE */
	{STM32_GPIO_PORT_C, STM32_GPIO_PIN_3},	/* L4, SDRAM_CKE */

	{STM32_GPIO_PORT_G, STM32_GPIO_PIN_8},	/* H14, SDRAM_CLK */
};
